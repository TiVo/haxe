...
module Define = struct
	...
	let infos = function
		...
		| TiVoApplyMdoFixupMacro -> ("tivo_apply_mdo_fixup_macro", "TiVo HACK -- force the application of a @:build macro invocation for the special TiVo MDO fixup macro")
...
let create version s_version args =
	...
	let defines =
		PMap.add "true" "1" (
		PMap.add "source-header" "Generated_by_Haxe" (
